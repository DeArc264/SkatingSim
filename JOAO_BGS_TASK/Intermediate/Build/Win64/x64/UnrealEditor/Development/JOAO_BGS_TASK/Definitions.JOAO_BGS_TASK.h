...
#define UE_PROJECT_NAME JOAO_BGS_TASK
#define UE_TARGET_NAME JOAO_BGS_TASKEditor
#define UE_MODULE_NAME "JOAO_BGS_TASK"
...
#define JOAO_BGS_TASK_API DLLEXPORT
